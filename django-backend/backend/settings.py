"""
Django settings for security monitoring backend.
"""
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'corsheaders',
    'django_celery_beat',  # permet de stocker/éditer les tâches planifiées en base (admin UI).
    'django_extensions',    # Development tools (shell_plus, etc.)
...
ROOT_URLCONF = 'backend.urls' #point d'entrée des routes
...
WSGI_APPLICATION = 'backend.wsgi.application' # used for deployment

# Database - PostgreSQL
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': os.getenv('DATABASE_NAME', 'security_monitor'),
